...
var keyOWM = "f6902099c5861eb71633b6ef9828c452"; //llave usada en clima y en alertas meteorologicas
...
app.get('/clima/:ciudad', (req, res) => {
    ...
    //obtiene toda la informacion relacionada con un cantante o una banda
...
app.get('/entretenimiento/studioghiblipeliculas/Castillo_Ambulante', (req, res) => {
    const END_POINT = `https://ghibliapi.herokuapp.com/films/cd3d059c-09f4-4ff3-8d63-bc765a5184fa`;
    axios.get(END_POINT) //traerme una respuesta
        .then(function(response) {
            console.log(response.data)
            res.send(response.data)
...
app.post('/personarandom', (req, res) => {
        axios.get(`https://randomuser.me/api/?password=${req.body.password}&results=${req.body.results}&gender=${req.body.gender}&nat=${req.body.nat}`)
            .then(function(json) {
